...
local t, e
t = Map("wolplus", translate("WakeOnLan Plus"), translate("Wake Up Your LAN Device.") .. [[<br/><br/><a href="https://github.com/sundaqiang/openwrt-packages" target="_blank">Powered by sundaqiang</a>]])
